    ...
    <div className="min-h-screen bg-slate-50 flex flex-col max-w-md mx-auto h-screen overflow-hidden border-x border-slate-200">
      <header className="bg-white border-b px-4 py-3 flex items-center justify-between shadow-sm z-20">
        <div>
          ...
          <p className="text-[7px] font-bold text-slate-400 uppercase tracking-widest leading-none">V4.5 Classic Flow</p>
        </div>
      ...
      <main className="flex-1 overflow-hidden relative bg-slate-50">
        ...
        {view === 'settings' && <SettingsView transactions={transactions} setTransactions={setTransactions} onClear={handleClearData} sheetsUrl={sheetsUrl} setSheetsUrl={setSheetsUrl} />}
      </main>
