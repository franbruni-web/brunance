...
export const PAYMENT_METHODS: PaymentMethod[] = [
  ...
  { id: 'cash-empresa', name: 'Efectivo Empresa', category: PaymentCategory.EMPRESA, allowedPayers: ['Fran'], owner: 'Fran' },
  { id: 'mp-fran', name: 'Dinero Mercado Pago Fran', category: PaymentCategory.BILLETERA_DIGITAL, allowedPayers: ['Fran'], owner: 'Fran' },
  { id: 'db-bna-fran', name: 'Débito BNA Fran', category: PaymentCategory.TARJETA_DEBITO, bank: 'BNA', allowedPayers: ['Fran'], owner: 'Fran' },
  { id: 'db-bapro-fran', name: 'Débito Bapro Fran', category: PaymentCategory.TARJETA_DEBITO, bank: 'Bapro', allowedPayers: ['Fran'], owner: 'Fran' },
  { id: 'db-macro-fran', name: 'Débito Macro Fran', category: PaymentCategory.TARJETA_DEBITO, bank: 'Macro', allowedPayers: ['Fran'], owner: 'Fran' },
  ...
  { id: 'db-macro-car', name: 'Débito Macro Car', category: PaymentCategory.TARJETA_DEBITO, bank: 'Macro', allowedPayers: ['Car'], owner: 'Car' },
